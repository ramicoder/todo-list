...
function createWorkspace(title, projects = []) {
  if (workspaces.length >= 2) {
    console.log(
      "To have more than 2 workspaces, please proceed to payment for subscription.",
    );
    alert(
      "You reached your workspace limit! To have more than 2 workspaces, please proceed to payment for subscription.",
    );
    return;
  } else {
